...
namespace UI {
    ...
    public class UI_LaserPointerInputModule : BaseInputModule {

        public static UI_LaserPointerInputModule instance { get { return _instance; } }
        private static UI_LaserPointerInputModule _instance = null;

        public LayerMask layerMask;

        // storage class for controller specific data
        private class ControllerData {
            public UI_LaserPointerEventData pointerEvent;
        ...
        private HashSet<UI_LaserPointer> _controllers;
        // controller data
        private Dictionary<UI_LaserPointer, ControllerData> _controllerData = new Dictionary<UI_LaserPointer, ControllerData>();
        ...
        public void AddController(UI_LaserPointer controller)
        {
            _controllerData.Add(controller, new ControllerData());
        }

        public void RemoveController(UI_LaserPointer controller)
        {
            _controllerData.Remove(controller);
        }

        protected void UpdateCameraPosition(UI_LaserPointer controller)
        {
        ...
        public override void Process()
        {
            ...
            foreach(var pair in _controllerData) {
                UI_LaserPointer controller = pair.Key;
                ...
                if(data.pointerEvent == null)
                    data.pointerEvent = new UI_LaserPointerEventData(eventSystem);
                else
